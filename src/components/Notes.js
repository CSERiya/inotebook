...
setNotes({id:currentNote._id, etitle:currentNote.title, edescription:currentNote.description, etag:currentNote.tag});
  ...
  <div className="mb-3">
    ...
    <input type="text" className="form-control" id="etag" name="etag" value={note.etag} placeholder="Enter tag here"
    onChange={onChange} />
  </div>
            ...
            <div className="modal-footer">
              ...
              <button disabled={note.edescription.length<5} onClick={handleClick} 
      ...
      <div className="row my-3">
        ...
        {notes.map((notes) => {
            return (
              <Noteitems key={notes._id} updateNote={updateNote} showAlert={props.showAlert} notes={notes}/>
            );
          })}
